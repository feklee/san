...
#+HTML_HEAD: <script type="text/javascript" src="x3dom.js"></script>
#+HTML_HEAD: <link rel="stylesheet" type="text/css" href="x3dom.css" />
...
<x3d width="500px" height="400px">
    <scene>
            <Inline nameSpaceName="Node" mapDEFToID="true" url="node.x3dv" />
    </scene>
</x3d>
#+END_EXPORT
