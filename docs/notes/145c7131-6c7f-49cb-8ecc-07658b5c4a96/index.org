...
The fitness of an individual is calculated in up to four steps…
...
In most runs, maybe nine out of ten times, the gentic algorithm does
not find a good solution. It gets stuck in a local minimum.
