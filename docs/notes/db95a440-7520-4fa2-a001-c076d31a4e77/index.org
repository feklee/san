...
- /Does the ZX62D-B-5P8 Micro-USB connector require wave soldering?/

  If it requires wave soldering, then possibly having the battery
  holder pad underneath is problematic, although both connections are
  to ground.

  The component has SKU 320010005 in the Seeed OPL ([[https://statics3.seeedstudio.com/images/opl/datasheet/320010005.pdf][datasheet]]).
