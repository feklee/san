...
accelerometer circuit fits on the top board, then only a six pins are
needed.


** Inside

The author of this document visited a Seeed Studio assembly line in
Shenzhen as part of Mitch Altman’s 2017 [[https://www.noisebridge.net/wiki/NoisebridgeChinaTrip7][Hacker Trip to China]].
